...
<body class="font-sans antialiased bg-white text-gray-800 min-h-full flex items-center justify-center bg-radial-gradient overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto px-6 py-12 text-center relative z-10">
        ...
        <div class="relative mb-12">
            <h1 class="text-[180px] md:text-[240px] font-bold text-gray-100 text-stroke tracking-tighter leading-none select-none">404</h1>
            <div class="absolute inset-0 flex flex-col items-center justify-center">
                <h2 class="text-4xl md:text-6xl font-bold text-red-600 mb-2 font-playfair">Lost in the Digital Void</h2>
                <div class="w-24 h-1 bg-red-400 my-4"></div>
                <p class="text-xl text-gray-600 max-w-lg">The page you're seeking has vanished into the ether</p>
            </div>
        </div>

        <!-- Central Illustration -->
        <div class="relative w-80 h-80 mx-auto mb-16">
            <!-- Floating Elements -->
        ...
        <div class="max-w-2xl mx-auto mb-16 relative">
            ...
            <h3 class="text-3xl font-semibold text-gray-800 mb-4">Oops! Page Not Found</h3>
            <p class="text-gray-600 mb-8 text-lg leading-relaxed">
                The digital realm is vast, and sometimes pages wander off. Let us guide you back to familiar territory.
            </p>
