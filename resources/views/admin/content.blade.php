<x-admin-layout>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($content->status == 'Active' || $content->status == '1')
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <button onclick="showConfirmModal('deleteContentModal', 'submitDeleteContentForm({{ $content->id }})')" 
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <span class="px-3 py-1 text-xs font-semibold rounded-full 
                                    {{ ($content->status == 'Active' || $content->status == '1') ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                    {{ ($content->status == 'Active' || $content->status == '1') ? 'Active' : 'Inactive' }}
                                </span>
                            </div>
    ...
    <script>
        function submitDeleteContentForm(contentId) {
